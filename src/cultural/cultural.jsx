...
const CulturalPage = () => {
    ...
    const EventCard = ({ imgSrc, title, to, rule }) => {
            ...
            const culturalEvents = [
                { imgSrc: "/mehendi.jpg", title: "Mehndi", to: "/mehndi" },
                { imgSrc: "/rangoli.png", title: "Rangoli", to: "/rangoli" },
                { imgSrc: "/speech.png", title: "Vernacular Speech", to: "/speech" },
                { imgSrc: "/lippan.jpeg", title: "Lippan Art", to: "/lippan" },
                { imgSrc: "/doodle.png", title: "Doodling", to: "/doodling" },
                { imgSrc: "/cooking.jpeg", title: "Cooking Competition", to: "/cooking" },
                { imgSrc: "/qirat.png", title: "Qirat", to: "/qirat" },
                { imgSrc: "/treasure.jpeg", title: "Treasure Hunt", to: "/treasure" },
                { imgSrc: "/standup.png", title: "Stand-Up Comedy", to: "/standup" },
                { imgSrc: "/naat.png", title: "Hamd-o-Naat", to: "/naat" },
                { imgSrc: "/mushaira.jpeg", title: "Mushaira", to: "/mushaira" },
                { imgSrc: "/pot.jpeg", title: "Pot Painting", to: "/potpainting" },
                { imgSrc: "/debate.png", title: "Debate", to: "/debate" },
                { imgSrc: "/zaika.jpeg", title: "Zaika", to: "/zaika" },
                { imgSrc: "/extempore.png", title: "Extempore", to: "/extempore" },
                { imgSrc: "/vlog.png", title: "Vlog", to: "/vlog" },
                { imgSrc: "/calligraphy.png", title: "CalliGraphy", to: "/calligraphy" },
