...
const CalligraphyRegistration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://bonhomie.onrender.com/group-sports', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className="container mx-auto mt-12 p-6 bg-white rounded-lg shadow-lg max-w-3xl">
            ...
            {alertMessage && (
                <div
                    className={`${alertType === 'success' ? 'bg-green-100 border-green-500 text-green-700' : 'bg-red-100 border-red-500 text-red-700'
                        } border-l-4 p-4 mb-4`}
                    role="alert"
                >
...
export default CalligraphyRegistration;
